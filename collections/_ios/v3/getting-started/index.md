...
To start quickly with simple examples of a MapsIndoors implementations clone [this repository](https://github.com/MapsIndoors/MapsIndoorsIOS/tree/master)) and run the XCode Scheme called *Demos*. The code for these samples are to find in the */Example/DemoSamples* folder.
