...
const Dropdown = class {
    ...
    render() {
        ...
        return (h(Host, null, h("mi-card", { class: { 'open': this.open, 'closed': !this.open, 'no-select': true }, tabindex: "0" }, h("header", { onClick: (e) => this.toggle(e) }, h("span", null, headline)), h("section", null, h("hr", null), filter, multiple, h("ul", null, this.currentItems.map((item, index) => this.renderListItem(item, index, multiple)))))));
    }
    /**
     ...
     */
    renderFiltering() {
        return (h("div", { class: "filter-container" }, h("input", { type: "text", placeholder: "Type to filter", ref: (el) => this.filterElement = el, onInput: (e) => { this.filter(); }, tabIndex: this.open ? 0 : -1 })));
    }
    /**
    ...
    renderMultipleOptions() {
        return (h("div", { class: "multiple-options" }, h("a", { onClick: (e) => this.selectAll() }, "Select all"), h("a", { onClick: () => this.selectNone() }, "Select none")));
    }
    /**
    ...
    renderListItem(item, index, showCheckBox) {
        return (h("li", null, h("label", null, h("input", { type: "checkbox", value: index, checked: item.selected, onChange: (e) => this.onSelect(e, item, index), class: { 'hidden': !showCheckBox } }), item.text)));
    }
