...
import { r as registerInstance, h, H as Host, g as getElement, c as createEvent, f as forceUpdate } from './index-426ce5ad.js';
var Card = /** @class */ (function () {
    ...
    Object.defineProperty(Card, "style", {
        get: function () { return ":host{-webkit-box-sizing:border-box;box-sizing:border-box;display:block;font-family:Inter, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Fira Sans\", \"Droid Sans\", \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";background-color:#ffffff;-webkit-box-shadow:0 1px 1px rgba(0, 0, 0, 0.1), 0 2px 2px rgba(0, 0, 0, 0.1), 0 4px 4px rgba(0, 0, 0, 0.1);box-shadow:0 1px 1px rgba(0, 0, 0, 0.1), 0 2px 2px rgba(0, 0, 0, 0.1), 0 4px 4px rgba(0, 0, 0, 0.1);border-radius:8px;padding-top:32px;padding-bottom:32px;padding-left:32px;padding-right:32px;margin:24px}"; },
        enumerable: true,
        configurable: true
    });
    return Card;
...
var DataTable = /** @class */ (function () {
    function DataTable(hostRef) {
        registerInstance(this, hostRef);
        this.columns = [];
        this.rows = [];
    }
    DataTable.prototype.connectedCallback = function () {
        var columns = this.el.querySelectorAll('mi-column');
        this.columns = Array.from(columns).map(function (column) {
            return {
    ...
    DataTable.prototype.sort = function (event, column) {
        if (column.sortable) {
            ...
            var sortOrder = th.classList.contains('asc') ? 'desc' : th.classList.contains('desc') ? 'asc' : 'desc';
            var method = sortOrder === 'desc' ? desc(column.binding) : asc(column.binding);
            tr.querySelectorAll('th').forEach(function (td) {
                td.classList.remove('desc');
                td.classList.remove('asc');
            });
            th.classList.add(sortOrder);
            this.rows = __spreadArrays(this.rows.sort(method));
        }
    };
    DataTable.prototype.render = function () {
        var _this_1 = this;
        var rows = isNumber(this.maxRows) && this.maxRows > 0 ? this.rows.slice(0, this.maxRows) : this.rows;
        return (h(Host, null, h("table", null, h("thead", null, h("tr", null, this.columns.map(function (column) { return h("th", { onClick: function (event) { return column.sortable && _this_1.sort(event, column); }, class: { "no-sort": !column.sortable } }, column.label); }))), h("tbody", null, rows.map(function (row) { return h("tr", null, _this_1.columns.map(function (column) {
            var template = column.template;
            if (template > '') {
                template = template.replace(/\{(.*?)\}/g, function (match, capture) {
                    return row[capture] || '';
                });
            }
...
var build = createCommonjsModule(function (module, exports) {
     ...
     *
     */
    !function (t, e) { module.exports = e(); }(window, (function () { return function (t) { var e = {}; function __webpack_require__(n) { if (e[n])
        return e[n].exports; var o = e[n] = { i: n, l: !1, exports: {} }; return t[n].call(o.exports, o, o.exports, __webpack_require__), o.l = !0, o.exports; } return __webpack_require__.m = t, __webpack_require__.c = e, __webpack_require__.d = function (t, e, n) { __webpack_require__.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: n }); }, __webpack_require__.r = function (t) { "undefined" !== typeof Symbol && Symbol.toStringTag && Object.defineProperty(t, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t, "__esModule", { value: !0 }); }, __webpack_require__.t = function (t, e) { if (1 & e && (t = __webpack_require__(t)), 8 & e)
        return t; if (4 & e && "object" === typeof t && t && t.__esModule)
        return t; var n = Object.create(null); if (__webpack_require__.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: t }), 2 & e && "string" != typeof t)
        for (var o in t)
            __webpack_require__.d(n, o, function (e) { return t[e]; }.bind(null, o)); return n; }, __webpack_require__.n = function (t) { var e = t && t.__esModule ? function () { return t.default; } : function () { return t; }; return __webpack_require__.d(e, "a", e), e; }, __webpack_require__.o = function (t, e) { return Object.prototype.hasOwnProperty.call(t, e); }, __webpack_require__.p = "", __webpack_require__(__webpack_require__.s = 0); }([function (t, e, n) { t.exports = n(2); }, function (t, e, n) { }, function (t, e, n) { n.r(e); n(1); function _createForOfIteratorHelper(t, e) { var n; if ("undefined" === typeof Symbol || null == t[Symbol.iterator]) {
            if (Array.isArray(t) || (n = function (t, e) { if (!t)
                return; if ("string" === typeof t)
                return _arrayLikeToArray(t, e); var n = Object.prototype.toString.call(t).slice(8, -1); "Object" === n && t.constructor && (n = t.constructor.name); if ("Map" === n || "Set" === n)
                return Array.from(t); if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))
                return _arrayLikeToArray(t, e); }(t)) || e && t && "number" === typeof t.length) {
                n && (t = n);
                var o = 0, F = function () { };
                return { s: F, n: function () { return o >= t.length ? { done: !0 } : { done: !1, value: t[o++] }; }, e: function (t) { throw t; }, f: F };
            }
            throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        } var i, s = !0, a = !1; return { s: function () { n = t[Symbol.iterator](); }, n: function () { var t = n.next(); return s = t.done, t; }, e: function (t) { a = !0, i = t; }, f: function () { try {
                s || null == n.return || n.return();
            }
            finally {
                if (a)
                    throw i;
            } } }; } function _arrayLikeToArray(t, e) { (null == e || e > t.length) && (e = t.length); for (var n = 0, o = new Array(e); n < e; n++)
            o[n] = t[n]; return o; } function _typeof(t) { return (_typeof = "function" === typeof Symbol && "symbol" === typeof Symbol.iterator ? function (t) { return typeof t; } : function (t) { return t && "function" === typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t; })(t); } function _defineProperties(t, e) { for (var n = 0; n < e.length; n++) {
            var o = e[n];
            o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, o.key, o);
        } } var o = function () { function Utilities(t) { var e = t.getOptions, n = t.getCaretPosition, o = t.dispatch; !function (t, e) { if (!(t instanceof e))
            throw new TypeError("Cannot call a class as a function"); }(this, Utilities), this.getOptions = e, this.getCaretPosition = n, this.dispatch = o, Utilities.bindMethods(Utilities, this); } var t, e, n; return t = Utilities, n = [{ key: "bindMethods", value: function (t, e) { var n, o = _createForOfIteratorHelper(Object.getOwnPropertyNames(t.prototype)); try {
                    for (o.s(); !(n = o.n()).done;) {
                        var i = n.value;
                ...
                } } }, { key: "isMaxLengthReached", value: function () { return Boolean(this.maxLengthReached); } }, { key: "isTouchDevice", value: function () { return "ontouchstart" in window || navigator.maxTouchPoints; } }, { key: "pointerEventsSupported", value: function () { return window.PointerEvent; } }, { key: "camelCase", value: function (t) { return !!t && t.toLowerCase().trim().split(/[.\-_\s]/g).reduce((function (t, e) { return e.length ? t + e[0].toUpperCase() + e.slice(1) : t; })); } }]) && _defineProperties(t.prototype, e), n && _defineProperties(t, n), Utilities; }(); function PhysicalKeyboard_defineProperties(t, e) { for (var n = 0; n < e.length; n++) {
            var o = e[n];
            o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, o.key, o);
        } } var i = function () { function PhysicalKeyboard(t) { var e = t.dispatch, n = t.getOptions; !function (t, e) { if (!(t instanceof e))
            throw new TypeError("Cannot call a class as a function"); }(this, PhysicalKeyboard), this.dispatch = e, this.getOptions = n, o.bindMethods(PhysicalKeyboard, this); } var t, e; return t = PhysicalKeyboard, (e = [{ key: "handleHighlightKeyDown", value: function (t) { var e = this.getOptions(), n = this.getSimpleKeyboardLayoutKey(t); this.dispatch((function (t) { var o = t.getButtonElement(n) || t.getButtonElement("{".concat(n, "}")); o && (o.style.backgroundColor = e.physicalKeyboardHighlightBgColor || "#9ab4d0", o.style.color = e.physicalKeyboardHighlightTextColor || "white"); })); } }, { key: "handleHighlightKeyUp", value: function (t) { var e = this.getSimpleKeyboardLayoutKey(t); this.dispatch((function (t) { var n = t.getButtonElement(e) || t.getButtonElement("{".concat(e, "}")); n && n.removeAttribute && n.removeAttribute("style"); })); } }, { key: "getSimpleKeyboardLayoutKey", value: function (t) { var e; return ((e = t.code.includes("Numpad") || t.code.includes("Shift") || t.code.includes("Space") || t.code.includes("Backspace") || t.code.includes("Control") || t.code.includes("Alt") || t.code.includes("Meta") ? t.code : t.key) !== e.toUpperCase() || "F" === t.code[0] && Number.isInteger(Number(t.code[1])) && t.code.length <= 3) && (e = e.toLowerCase()), e; } }]) && PhysicalKeyboard_defineProperties(t.prototype, e), PhysicalKeyboard; }(); function _toConsumableArray(t) { return function (t) { if (Array.isArray(t))
            return Keyboard_arrayLikeToArray(t); }(t) || function (t) { if ("undefined" !== typeof Symbol && Symbol.iterator in Object(t))
            return Array.from(t); }(t) || function (t, e) { if (!t)
            return; if ("string" === typeof t)
            return Keyboard_arrayLikeToArray(t, e); var n = Object.prototype.toString.call(t).slice(8, -1); "Object" === n && t.constructor && (n = t.constructor.name); if ("Map" === n || "Set" === n)
            return Array.from(t); if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))
            return Keyboard_arrayLikeToArray(t, e); }(t) || function () { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }(); } function Keyboard_arrayLikeToArray(t, e) { (null == e || e > t.length) && (e = t.length); for (var n = 0, o = new Array(e); n < e; n++)
            o[n] = t[n]; return o; } function Keyboard_classCallCheck(t, e) { if (!(t instanceof e))
            throw new TypeError("Cannot call a class as a function"); } function Keyboard_defineProperties(t, e) { for (var n = 0; n < e.length; n++) {
            var o = e[n];
            o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, o.key, o);
        } } function _defineProperty(t, e, n) { return e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t; } var s = function () { function SimpleKeyboard() { var t = this; Keyboard_classCallCheck(this, SimpleKeyboard), _defineProperty(this, "handleParams", (function (t) { var e, n, o; if ("string" === typeof t[0])
            e = t[0].split(".").join(""), n = document.querySelector(".".concat(e)), o = t[1];
            ...
            e = "simple-keyboard", n = document.querySelector(".".concat(e)), o = t[0]; return { keyboardDOMClass: e, keyboardDOM: n, options: o }; })), _defineProperty(this, "getOptions", (function () { return t.options; })), _defineProperty(this, "getCaretPosition", (function () { return t.caretPosition; })), _defineProperty(this, "registerModule", (function (e, n) { t.modules[e] || (t.modules[e] = {}), n(t.modules[e]); })), _defineProperty(this, "getKeyboardClassString", (function () { for (var e = arguments.length, n = new Array(e), o = 0; o < e; o++)
            n[o] = arguments[o]; var i = [t.keyboardDOMClass].concat(n).filter((function (t) { return !!t; })); return i.join(" "); })); for (var e = arguments.length, n = new Array(e), s = 0; s < e; s++)
            n[s] = arguments[s]; var a = this.handleParams(n), r = a.keyboardDOMClass, u = a.keyboardDOM, c = a.options, l = void 0 === c ? {} : c; if (this.utilities = new o({ getOptions: this.getOptions, getCaretPosition: this.getCaretPosition, dispatch: this.dispatch }), this.caretPosition = null, this.keyboardDOM = u, this.options = l, this.options.layoutName = this.options.layoutName || "default", this.options.theme = this.options.theme || "hg-theme-default", this.options.inputName = this.options.inputName || "default", this.options.preventMouseDownDefault = this.options.preventMouseDownDefault || !1, this.keyboardPluginClasses = "", o.bindMethods(SimpleKeyboard, this), this.input = {}, this.input[this.options.inputName] = "", this.keyboardDOMClass = r, this.buttonElements = {}, window.SimpleKeyboardInstances || (window.SimpleKeyboardInstances = {}), this.currentInstanceName = this.utilities.camelCase(this.keyboardDOMClass), window.SimpleKeyboardInstances[this.currentInstanceName] = this, this.allKeyboardInstances = window.SimpleKeyboardInstances, this.keyboardInstanceNames = Object.keys(window.SimpleKeyboardInstances), this.isFirstKeyboardInstance = this.keyboardInstanceNames[0] === this.currentInstanceName, this.physicalKeyboard = new i({ dispatch: this.dispatch, getOptions: this.getOptions }), !this.keyboardDOM)
            throw console.warn('".'.concat(r, '" was not found in the DOM.')), new Error("KEYBOARD_DOM_ERROR"); this.render(), this.modules = {}, this.loadModules(); } var t, e; return t = SimpleKeyboard, (e = [{ key: "handleButtonClicked", value: function (t) { var e = this.options.debug; if ("{//}" === t)
                    return !1; "function" === typeof this.options.onKeyPress && this.options.onKeyPress(t), this.input[this.options.inputName] || (this.input[this.options.inputName] = ""); var n = this.utilities.getUpdatedInput(t, this.input[this.options.inputName], this.caretPosition); if (this.input[this.options.inputName] !== n && (!this.options.inputPattern || this.options.inputPattern && this.inputPatternIsValid(n))) {
                    if (this.options.maxLength && this.utilities.handleMaxLength(this.input, n))
                        return !1;
...
var defaultAlphabetic = unitedStatesAlphabetic;
var defaultNumeric = {
    default: ['1 2 3', '4 5 6', '7 8 9', '0 {bksp}']
};
var Keyboard = /** @class */ (function () {
    function Keyboard(hostRef) {
        registerInstance(this, hostRef);
        /**
    ...
    Keyboard.prototype.inputElementChange = function () {
        var _this_1 = this;
        ...
        if (!this.inputElements.has(this.inputElement)) {
            ...
            var eventsToListenFor = ['input', 'focus', 'blur', 'inputCleared'];
            eventsToListenFor.forEach(function (event) {
                _this_1.inputElement.addEventListener(event, function () {
                    _this_1.simpleKeyboard.setInput(_this_1.inputElement.value, _this_1.inputElement.id);
                });
            });
        }
    };
    Keyboard.prototype.layoutChange = function () {
        if (this.simpleKeyboard) {
            this.simpleKeyboard.setOptions({ layout: this.getKeyboardLayout(this.layout) });
        }
    };
    Keyboard.prototype.componentDidLoad = function () {
        var _this_1 = this;
        this.simpleKeyboard = new SimpleKeyboard({
            onChange: function (input) {
                if (_this_1.inputElement) {
                    _this_1.inputElement.value = input;
                    _this_1.inputElement.dispatchEvent(new Event('input', { bubbles: true, cancelable: true }));
                }
            },
     ...
     * @returns {boolean}
     */
    Keyboard.prototype.isValidLayout = function (layout) {
        if (!layout)
            return false;
        return Object.values(KeyboardLayout).find(function (keyboardLayout) { return keyboardLayout === layout; }) ? true : false;
    };
    /**
     ...
     */
    Keyboard.prototype.getKeyboardLayout = function (keyboardLayout) {
        ...
        var supportedAlphabeticLayouts = [
            { layout: unitedStatesAlphabetic, languages: ['en', 'en-us'] },
            { layout: danishAlphabetic, languages: ['da'] }
        ];
        var supportedLayout = supportedAlphabeticLayouts.find(function (layout) {
            return layout.languages.find(function (language) { return language === browserLanguage.toLowerCase(); }) ? true : false;
        });
    ...
    Object.defineProperty(Keyboard, "watchers", {
        get: function () {
            return {
...
var List = /** @class */ (function () {
     ...
     * @private
     */
    List.prototype.updateScrollButtonsState = function () {
     ...
     * @private
     */
    List.prototype.setScrollContainerElementRef = function () {
     ...
     * @private
     */
    List.prototype.addIntersectionObserver = function () {
        var _this_1 = this;
        this.intersectionObserver = new IntersectionObserver(function (entries) {
            ...
            if (_this_1.scrollContainerElement.scrollHeight - _this_1.scrollContainerElement.scrollTop === _this_1.scrollContainerElement.clientHeight) {
                _this_1.updateScrollButtonsState();
            }
            _this_1.intersectionObserver.disconnect();
        });
        this.intersectionObserver.observe(this.scrollContainerElement);
    };
    List.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "container" }, h("div", { role: "list", class: "scroll-container", ref: function (el) { return _this_1.scrollContainerElement = el; } }, h("slot", null)), this.scrollButtonsEnabled ? h("mi-scroll-buttons", { scrollLength: this.scrollLength, ref: function (el) { return _this_1.miScrollButtonsElement = el; } }) : null));
    };
    Object.defineProperty(List, "style", {
        get: function () { return "html{-webkit-box-sizing:border-box;box-sizing:border-box}*,*:before,*:after{-webkit-box-sizing:inherit;box-sizing:inherit}:host{display:block;height:100%;width:100%}.container{height:100%;display:-ms-flexbox;display:flex}.container .scroll-container{width:100%;overflow-y:auto}"; },
        enumerable: true,
        configurable: true
    });
    return List;
}());
var ListItemCategory = /** @class */ (function () {
    function ListItemCategory(hostRef) {
        registerInstance(this, hostRef);
        /**
    ...
    ListItemCategory.prototype.componentDidRender = function () {
     ...
     */
    ListItemCategory.prototype.categoryClickedHandler = function (category) {
     ...
     */
    ListItemCategory.prototype.objectFitImage = function (image) {
    ...
    ListItemCategory.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, { onClick: function () { return _this_1.categoryClickedHandler(_this_1.category); } }, h("img", { ref: function (el) { return _this_1.image = el; }, src: this.category.iconUrl }), h("p", null, this.category.name)));
    };
    Object.defineProperty(ListItemCategory, "style", {
        get: function () { return "html{-webkit-box-sizing:border-box;box-sizing:border-box}*,*:before,*:after{-webkit-box-sizing:inherit;box-sizing:inherit}:host{color:#1e2025;-webkit-transition:300ms ease;transition:300ms ease;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;cursor:pointer}:host img{-o-object-fit:cover;object-fit:cover}:host([orientation=horizontal]){width:100%;height:100%;float:left;-ms-flex-direction:column;flex-direction:column;-ms-flex-pack:center;justify-content:center}:host([orientation=horizontal]) img{width:48px;height:48px}:host([orientation=horizontal]) p{height:16px;overflow:visible;font-size:0.875rem;line-height:1rem;text-align:center}:host([orientation=vertical]){padding:16px;-ms-flex-direction:row;flex-direction:row;font-size:1rem;font-weight:500;line-height:1.25rem}:host([orientation=vertical]) img{width:24px;height:24px}:host([orientation=vertical]) p{margin:0;padding-left:16px}:host(:hover){background-color:#fcfcfc}"; },
        enumerable: true,
        configurable: true
    });
...
var ListItemLocation = /** @class */ (function () {
    function ListItemLocation(hostRef) {
        registerInstance(this, hostRef);
        /**
     ...
     * @memberof List
     */
    ListItemLocation.prototype.locationClickedHandler = function (location) {
        this.locationClicked.emit(location);
    };
    ListItemLocation.prototype.componentWillLoad = function () {
    ...
    ListItemLocation.prototype.componentDidRender = function () {
     ...
     * @param {HTMLImageElement} image
     */
    ListItemLocation.prototype.objectFitImage = function (image) {
     ...
     * @returns {string}
     */
    ListItemLocation.prototype.getDistanceString = function (meters) {
     ...
     * @returns {JSX.Element}
     */
    ListItemLocation.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, { role: "listitem", onClick: function () { return _this_1.locationClickedHandler(_this_1.location); } }, this.location.properties.imageURL ? this.renderIcon() : null, h("div", { class: "details" }, h("p", { class: "details-title" }, this.location.properties.name), h("mi-location-info", { ref: function (el) { return _this_1.infoElement = el; } })), this.distance ? this.renderDistance() : null));
    };
    /**
     * @description Get JSX template for icon.
     * @returns {JSX.Element}
     */
    ListItemLocation.prototype.renderIcon = function () {
        var _this_1 = this;
        return (h("img", { ref: function (el) { return _this_1.imageElement = el; }, src: this.location.properties.imageURL }));
    };
    /**
     * @description Get JSX template for distance.
     * @returns {JSX.Element}
     */
    ListItemLocation.prototype.renderDistance = function () {
        return (h("div", { class: "distance" }, this.distance));
    };
    Object.defineProperty(ListItemLocation, "style", {
        get: function () { return "html{-webkit-box-sizing:border-box;box-sizing:border-box}*,*:before,*:after{-webkit-box-sizing:inherit;box-sizing:inherit}:host{padding:16px;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-align:center;align-items:center;color:#1e2025;font-size:1rem;font-weight:500;line-height:1.25rem;-webkit-transition:300ms ease;transition:300ms ease;cursor:pointer}:host(:hover){background-color:#fcfcfc}img{width:24px;height:24px;-o-object-fit:cover;object-fit:cover}.details{padding-left:16px;padding-right:16px;-ms-flex:1;flex:1}.details-title{margin:0;padding:0}.distance{font-weight:400}"; },
        enumerable: true,
        configurable: true
    });
...
var LocationInfo = /** @class */ (function () {
     ...
     * @returns {string}
     */
    LocationInfo.prototype.getInfoString = function () {
        var details = [];
    ...
    Object.defineProperty(LocationInfo, "style", {
        get: function () { return ":host{display:block;color:#444b55;font-weight:400}"; },
        enumerable: true,
        configurable: true
    });
    return LocationInfo;
...
var Map = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.locationClicked = createEvent(this, "locationClicked", 7);
        this.positionReceived = createEvent(this, "positionReceived", 7);
        this.positionError = createEvent(this, "positionError", 7);
        this.dragend = createEvent(this, "dragend", 7);
        this.idle = createEvent(this, "idle", 7);
    }
    class_1.prototype.apiKeyChange = function (newApiKey) {
        mapsindoors.MapsIndoors.setApiKey(newApiKey);
    };
    class_1.prototype.gmOptionsChange = function (newControlOptions) {
        this.googleMapInstance.setOptions(newControlOptions);
    };
    class_1.prototype.floorSelectorChange = function (newPosition, oldPosition) {
        if (this.floorSelectorInstance) {
            this.setFloorSelector(newPosition, oldPosition);
        }
    };
    class_1.prototype.positionControlChange = function (newPosition, oldPosition) {
        this.setPositionControl(newPosition, oldPosition);
    };
    class_1.prototype.floorChange = function (newFloor, oldFloor) {
    ...
    class_1.prototype.zoomChange = function (newZoom, oldZoom) {
    ...
    class_1.prototype.disableExternalLinksChange = function (attributeValue) {
        this.setExternalLinkBehavior(attributeValue);
    };
    class_1.prototype.polylineColorChange = function (newPolylineColor) {
    ...
    class_1.prototype.polylineWeightChange = function (newPolylineWeight) {
        if (this.directionsRenderer) {
    ...
    class_1.prototype.polylineOpacityChange = function (newPolylineOpacity) {
        if (this.directionsRenderer) {
     ...
     */
    class_1.prototype.getMapsIndoorsVersion = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.mapsIndoorsInstance.__VERSION__];
            });
        });
    };
    /**
     ...
     */
    class_1.prototype.panTo = function (latLng) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    class_1.prototype.fitBounds = function (bounds) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_1.prototype.getBounds = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.googleMapInstance.getBounds()];
            });
        });
    };
    /**
     ...
     */
    class_1.prototype.setDisplayRule = function (target, displayRule) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    class_1.prototype.setVenue = function (venue) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    class_1.prototype.fitVenue = function (venueId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.mapsIndoorsInstance.fitVenue(venueId)];
            });
        });
    };
    /**
     ...
     */
    class_1.prototype.openInfoWindow = function (content, anchor, className) {
     ...
     * Close info window.
     */
    class_1.prototype.closeInfoWindow = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    class_1.prototype.filterLocations = function (locationIds, fitView) {
        if (fitView === void 0) { fitView = false; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    class_1.prototype.clearLocationFilter = function (fitView) {
        if (fitView === void 0) { fitView = false; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    class_1.prototype.showRoute = function (routeParams) {
        return __awaiter(this, void 0, void 0, function () {
            var _this_1 = this;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, mapsindoors.DirectionsService.getRoute(routeParams).then(function (directionsResult) { return _this_1.setRoute(directionsResult); })];
            });
        });
    };
    /**
     ...
     */
    class_1.prototype.setRoute = function (directionsResult) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.directionsRenderer) {
     ...
     */
    class_1.prototype.clearRoute = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.directionsRenderer) {
     ...
     */
    class_1.prototype.nextRouteLeg = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.directionsRenderer) {
                    return [2 /*return*/];
     ...
     */
    class_1.prototype.previousRouteLeg = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.directionsRenderer) {
                    return [2 /*return*/];
     ...
     */
    class_1.prototype.setRouteLegIndex = function (index) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.directionsRenderer) {
                    return [2 /*return*/];
     ...
     */
    class_1.prototype.getRoute = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.directionsRenderer) {
                    return [2 /*return*/];
                }
                return [2 /*return*/, this.directionsRenderer.getRoute()];
            });
        });
    };
    class_1.prototype.componentDidLoad = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.initializeGoogleMaps()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.initialiseMapsIndoorsSDK()];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.setupMap()];
                    case 3:
                        _a.sent();
                        ...
                        google.maps.event.addListener(this.mapsIndoorsInstance, 'floor_changed', function (floor) {
                            _this_1.floor = floor;
                        });
                        google.maps.event.addListener(this.googleMapInstance, 'zoom_changed', function () {
                            _this_1.zoom = _this_1.googleMapInstance.getZoom();
                        });
                        return [2 /*return*/];
                }
            });
     ...
     */
    class_1.prototype.showFloorSelectorAfterUserInteraction = function () {
        var _this_1 = this;
        var eventsToListenFor = ['touchmove', 'click', 'wheel']; // these are events we consider as user interactions with the map
        var userInteracted = function () {
            eventsToListenFor.forEach(function (event) { return _this_1.mapDiv.removeEventListener(event, userInteracted); });
            _this_1.setFloorSelector(_this_1.floorSelector);
        };
        eventsToListenFor.forEach(function (event) { return _this_1.mapDiv.addEventListener(event, userInteracted); });
    };
    /**
     ...
     */
    class_1.prototype.initializeGoogleMaps = function () {
        var _this_1 = this;
        return new Promise(function (resolve) {
            // If no Google Maps API is globally available, insert script tag on page to fetch it.
            if (typeof google === 'undefined' || typeof google.maps === 'undefined') {
                _this_1.insertGoogleMapsScript().then(function () { return resolve(); });
                return;
            }
            ...
            var googleMapsScriptTag = document.querySelector('script[src*="maps.googleapis.com/maps/api"]');
            if (!googleMapsScriptTag) {
                return resolve(); // API available, but could not find script to check.
            }
            var currentApiKey = new URLSearchParams(googleMapsScriptTag.getAttribute('src')).get('key');
            if (currentApiKey !== _this_1.gmApiKey) {
     ...
     * @returns {Promise<void>}
     */
    class_1.prototype.insertGoogleMapsScript = function () {
        var _this_1 = this;
        return new Promise(function (resolve) {
            _this_1.googleMapsApiTag = document.createElement('script');
            _this_1.googleMapsApiTag.setAttribute('type', 'text/javascript');
            _this_1.googleMapsApiTag.setAttribute('src', "//maps.googleapis.com/maps/api/js?v=3&key=" + _this_1.gmApiKey + "&libraries=geometry,places");
            document.body.appendChild(_this_1.googleMapsApiTag);
            _this_1.googleMapsApiTag.onload = function () { return resolve(); };
        });
    };
    /**
     ...
     * @returns {Promise<void>}
     */
    class_1.prototype.initialiseMapsIndoorsSDK = function () {
        var _this_1 = this;
        return new Promise(function (resolve) {
            if (typeof mapsindoors !== 'undefined') {
                mapsindoors.MapsIndoors.setApiKey(_this_1.miApiKey);
                return resolve();
            }
            _this_1.miSdkApiTag = document.createElement('script');
            _this_1.miSdkApiTag.setAttribute('type', 'text/javascript');
            _this_1.miSdkApiTag.setAttribute('src', miVariables.miSDKUrl + "?apikey=" + _this_1.miApiKey);
            document.body.appendChild(_this_1.miSdkApiTag);
            _this_1.miSdkApiTag.onload = function () { return resolve(); };
        });
    };
    /**
     * Start Google map and MapsIndoors.
     */
    class_1.prototype.setupMap = function () {
        var _this_1 = this;
        return new Promise(function (resolve) {
            _this_1.googleMapInstance = new google.maps.Map(_this_1.mapDiv, _this_1.gmOptions);
            _this_1.mapsIndoorsInstance = new mapsindoors.MapsIndoors({
                map: _this_1.googleMapInstance
            });
            google.maps.event.addListener(_this_1.mapsIndoorsInstance, 'ready', function () {
                if (_this_1.floor !== undefined) {
                    // Floor attribute was set in the DOM initally: Set the floor
                    _this_1.mapsIndoorsInstance.setFloor(_this_1.floor);
                }
                else {
                    _this_1.floor = _this_1.mapsIndoorsInstance.getFloor();
                }
                _this_1.mapsIndoorsReady.emit();
                resolve();
            });
            _this_1.setExternalLinkBehavior(_this_1.disableExternalLinks);
            _this_1.relayEvents();
            _this_1.infoWindow = new google.maps.InfoWindow;
        });
    };
    /**
     * Setup listeners for some MapsIndoors and Google Map events and emit them out of component.
     */
    class_1.prototype.relayEvents = function () {
        var _this_1 = this;
        google.maps.event.addListener(this.mapsIndoorsInstance, 'click', function (location) { return _this_1.locationClicked.emit(location); });
        google.maps.event.addListener(this.googleMapInstance, 'dragend', function () { return _this_1.dragend.emit(); });
        google.maps.event.addListener(this.googleMapInstance, 'idle', function () { return _this_1.idle.emit(); });
    };
    /**
     * Prevent external links from opening.
     * @param {MouseEvent} event
     */
    class_1.prototype.preventExternalLink = function (event) {
        var externalLink = event.target.closest('a[target="_blank"]');
        if (externalLink) {
     ...
     */
    class_1.prototype.setExternalLinkBehavior = function (shouldDisableLinks) {
     ...
     */
    class_1.prototype.removeGoogleMapControl = function (position, className) {
        var controls = this.googleMapInstance.controls[google.maps.ControlPosition[position]].getArray();
        var controlIndex = controls.findIndex(function (control) { return control.classList.contains(className); });
     ...
     */
    class_1.prototype.setFloorSelector = function (mapControlPosition, oldMapControlPosition) {
        if (oldMapControlPosition === void 0) { oldMapControlPosition = undefined; }
     ...
     */
    class_1.prototype.setPositionControl = function (mapControlPosition, oldMapControlPosition) {
        if (oldMapControlPosition === void 0) { oldMapControlPosition = undefined; }
        if (mapControlPosition === null) {
     ...
     */
    class_1.prototype.setPositionEventListeners = function () {
        var _this_1 = this;
        google.maps.event.addListener(this.mapsIndoorsInstance, 'position_received', function (position) {
            _this_1.positionReceived.emit(position);
        });
        google.maps.event.addListener(this.mapsIndoorsInstance, 'position_error', function (error) {
            _this_1.positionError.emit(error);
        });
    };
    /**
     * Remove event listeners for position events.
     */
    class_1.prototype.clearPositionEventListeners = function () {
    ...
    class_1.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { ref: function (el) { return _this_1.mapDiv = el; } }));
    };
...
var MetricCard = /** @class */ (function () {
    ...
    MetricCard.prototype.renderContent = function () {
        var _this_1 = this;
        var value;
        if (this.value) {
...
var Notification = /** @class */ (function () {
     ...
     * @returns {Promise<void>}
     */
    class_2.prototype.push = function (message, type, sticky) {
        if (type === void 0) { type = 'none'; }
        if (sticky === void 0) { sticky = false; }
        return __awaiter(this, void 0, void 0, function () {
            var typeExist, notificationMessage;
            var _this_1 = this;
            return __generator(this, function (_a) {
                if (typeof message !== 'string' || message.length < 1) {
                    return [2 /*return*/];
                }
                typeExist = Object.values(NotificationType)
                    .some(function (notificationType) { return notificationType === type; });
                if (!typeExist) {
                    // eslint-disable-next-line no-console
                ...
                if (sticky === false) {
                    notificationMessage.timer = window.setTimeout(function () { return _this_1.dismiss(notificationMessage.id); }, (this.duration * 1000));
                }
                this.notificationId++;
     ...
     * @returns {Promise<void>}
     */
    class_2.prototype.clearAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.notifications = [];
                forceUpdate(this.hostElement);
     ...
     * @param {number} id
     */
    class_2.prototype.dismiss = function (id) {
        this.notifications = this.notifications.filter(function (notification) { return notification.id !== id; });
        forceUpdate(this.hostElement);
    };
    class_2.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, { class: this.position }, this.notifications.map(function (notification) { return _this_1.renderNotification(notification); })));
    };
    /**
     ...
     * @returns {JSX.Element}
     */
    class_2.prototype.renderIcon = function (type) {
...
var ScrollButtons = /** @class */ (function () {
     ...
     */
    class_3.prototype.addScrollEventListener = function () {
        var _this_1 = this;
        this.scrollContainerElementRef.addEventListener('scroll', function () {
            _this_1.updateScrollButtonsState();
        });
    };
    /**
     ...
     * @memberof ScrollButtons
     */
    class_3.prototype.updateScrollButtonsState = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     * @memberof ScrollButtons
     */
    class_3.prototype.updateScrollPosition = function (value) {
    ...
    class_3.prototype.render = function () {
        var _this_1 = this;
        return (h("div", { class: "scroll-buttons" }, h("button", { class: "mi-button mi-button--base btn btn-up", type: "button", disabled: true, "aria-label": "Scroll Up", ref: function (el) { return _this_1.upButtonElement = el; }, onClick: function () { return _this_1.updateScrollPosition(-_this_1.scrollLength); } }), h("button", { class: "mi-button mi-button--base btn btn-down", type: "button", "aria-label": "Scroll Down", ref: function (el) { return _this_1.downButtonElement = el; }, onClick: function () { return _this_1.updateScrollPosition(_this_1.scrollLength); } })));
    };
...
var Search = /** @class */ (function () {
    ...
    class_4.prototype.valueChange = function (newValue) {
     ...
     */
    class_4.prototype.clear = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    class_4.prototype.inputChanged = function () {
        var _this_1 = this;
        ...
        if (inputValue.length > 1 && inputValue !== this.lastRequested) {
            Promise.all([
                ...
                _this_1.lastRequested = inputValue;
                _this_1.pushResults(results[0].concat(results[1]));
            });
        }
    };
    /**
     ...
     */
    class_4.prototype.pushResults = function (locations) {
     ...
     * @return {Promise<any[]>}
     */
    class_4.prototype.makeMapsIndoorsQuery = function (query) {
        if (!this.mapsindoors) {
     ...
     * @return {Promise<any>}
     */
    class_4.prototype.makeGooglePlacesQuery = function (query) {
        var _this_1 = this;
        if (this.google) {
        ...
        return new Promise(function (resolve) {
            ...
            if (_this_1.gmCountryCode) {
                params.componentRestrictions = { country: _this_1.gmCountryCode };
            }
            _this_1.googleAutocompleteService.getPlacePredictions(params, function (results) {
                var places = (results || []).map(function (result) { return ({
                    type: 'Feature',
                    properties: {
                        type: 'google_places',
    ...
    class_4.prototype.componentDidRender = function () {
        ...
        if (this.dataAttributes) {
            for (var key in this.dataAttributes) {
    ...
    class_4.prototype.render = function () {
        var _this_1 = this;
        return (h("input", { id: this.idAttribute ? this.idAttribute : null, type: "search", ref: function (el) { return _this_1.inputElement = el; }, onInput: function () { return _this_1.inputChanged(); }, placeholder: this.placeholder, autocomplete: "off" }));
    };
...
var ShareSms = /** @class */ (function () {
    function ShareSms(hostRef) {
        var _this_1 = this;
        registerInstance(this, hostRef);
        /**
        ...
        this.submitFormHandler = function (event) {
            event.preventDefault();
            var isParametersValid = _this_1.venueId && _this_1.originLocationId && _this_1.destinationLocationId ? true : false;
            if (!_this_1.formElement.checkValidity() || !isParametersValid) {
                if (!_this_1.countryCodeInputElement.validity.valid) {
                    _this_1.countryCodeInputElement.focus();
                }
                if (!_this_1.phoneNumberInputElement.validity.valid) {
                    _this_1.phoneNumberInputElement.focus();
                }
                return;
            }
            mapsindoors.ShareService.directionsToPhone(_this_1.venueId, _this_1.originLocationId, _this_1.destinationLocationId, _this_1.countryCodeInputElement.value, _this_1.phoneNumberInputElement.value)
                .then(function () { return _this_1.successfullySent.emit(); })
                .catch(function (err) { return _this_1.unsuccessfullySent.emit(err); });
        };
        this.successfullySent = createEvent(this, "successfullySent", 7);
        this.unsuccessfullySent = createEvent(this, "unsuccessfullySent", 7);
    }
    ShareSms.prototype.componentDidRender = function () {
        this.countryCodeInputElement.value = this.countryCode;
    };
    ShareSms.prototype.componentDidLoad = function () {
        this.addIntersectionObserver();
    };
    /**
     * Observe the input field for phone number and focus it on intersection.
     */
    ShareSms.prototype.addIntersectionObserver = function () {
        var _this_1 = this;
        this.intersectionObserver = new IntersectionObserver(function (entries) {
            if (entries[0].intersectionRatio <= 0) {
                return;
     ...
     */
    ShareSms.prototype.setKeyboardInputElement = function (event) {
        this.miKeyboardElement.inputElement = event.target;
    };
    /**
     * Update form validity.
     */
    ShareSms.prototype.updateFormValidity = function () {
        // Form validity check
...
var StepSwitcher = /** @class */ (function () {
     ...
     * @param {number} index
     */
    StepSwitcher.prototype.setStepIndex = function (index) {
        this.stepIndex = index;
        this.stepIndexChanged.emit(this.stepIndex);
    };
    StepSwitcher.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("button", { type: "button", disabled: this.steps.length === 0 || this.stepIndex === 0, onClick: function () { return _this_1.setStepIndex(_this_1.stepIndex - 1); } }, h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24px", height: "24px" }, h("path", { d: "M0 0h24v24H0V0z", fill: "none" }), h("path", { d: "M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z" }))), h("div", { class: "steps" }, this.heading ? h("p", null, this.heading) : null, h("div", { class: "steps__dots" }, this.steps.map(function (item, index) {
            var isActive = _this_1.stepIndex === index ? true : false;
            return h("span", { class: { 'active': isActive } });
        }))), h("button", { type: "button", disabled: this.steps.length === 0 || this.stepIndex === this.steps.length - 1, onClick: function () { return _this_1.setStepIndex(_this_1.stepIndex + 1); } }, h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24px", height: "24px" }, h("path", { d: "M0 0h24v24H0V0z", fill: "none" }), h("path", { d: "M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41z" })))));
    };
    Object.defineProperty(StepSwitcher, "style", {
        get: function () { return ":host{display:-ms-flexbox;display:flex}button{padding:16px;background-color:transparent;border:none}button:disabled svg{fill:#c8d0e0}button svg{fill:#444b55}div.steps{padding-top:12px;padding-bottom:12px;padding-left:4px;padding-right:4px;display:-ms-flexbox;display:flex;-ms-flex-positive:1;flex-grow:1;-ms-flex-direction:column;flex-direction:column;vertical-align:center;-ms-flex-pack:center;justify-content:center}div.steps p{margin:0;padding-bottom:8px;color:#1e2025;font-size:1rem;font-weight:500;line-height:1.25rem;text-align:center}div.steps__dots{display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center}div.steps__dots span{width:8px;height:8px;margin-right:8px;float:left;background-color:#c8d0e0;border-radius:50%}div.steps__dots span.active{background-color:#444b55}div.steps__dots span:last-child{margin-right:0px}"; },
        enumerable: true,
        configurable: true
    });
    return StepSwitcher;
...
var Tab = /** @class */ (function () {
    ...
    Tab.prototype.render = function () { return; };
    return Tab;
}());
var TabPanel = /** @class */ (function () {
    ...
    class_5.prototype.active = function (active) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (active !== undefined) {
                    this.isActive = !!active;
                }
                return [2 /*return*/, this.isActive];
            });
        });
    };
    ...
    Object.defineProperty(class_5, "style", {
        get: function () { return "div{display:none}div.active{font-family:Inter, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Fira Sans\", \"Droid Sans\", \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";-ms-flex-negative:0;flex-shrink:0;-ms-flex-positive:1;flex-grow:1;display:block}"; },
        enumerable: true,
        configurable: true
    });
    return class_5;
...
var Tabs = /** @class */ (function () {
    ...
    class_6.prototype.connectedCallback = function () {
        var _this_1 = this;
        var tabs = this.el.querySelectorAll('mi-tab');
        this.tabs = Array.from(tabs).reduce(function (tabs, tab, index) {
            var content = Array.from(_this_1.el.getElementsByTagName('mi-tab-panel')).find(function (el) { return el.id === tab.tabFor; });
            if (content) {
    ...
    class_6.prototype.selectTab = function (index) {
        return __awaiter(this, void 0, void 0, function () {
            var isTabActive;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tabs[index].content.active()];
                    case 1:
                        isTabActive = _a.sent();
                        if (!isTabActive) {
                            this.active = index;
                            this.tabs.forEach(function (tab, tabIndex) { return tab.content.active(tabIndex === index); });
                        }
                        return [2 /*return*/];
                }
            });
    ...
    class_6.prototype.render = function () {
        var _this_1 = this;
        return (h(Host, null, h("nav", null, h("ul", null, this.tabs.map(function (tab, index) {
            return h("li", { class: _this_1.active === index ? 'active' : '', onClick: function () { _this_1.selectTab(index); } }, tab.label);
...
export { Card as mi_card, Column as mi_column, DataTable as mi_data_table, Keyboard as mi_keyboard, List as mi_list, ListItemCategory as mi_list_item_category, ListItemLocation as mi_list_item_location, LocationInfo as mi_location_info, Map as mi_map, MetricCard as mi_metric_card, Notification as mi_notification, ScrollButtons as mi_scroll_buttons, Search as mi_search, ShareSms as mi_share_sms, Spinner as mi_spinner, StepSwitcher as mi_step_switcher, Tab as mi_tab, TabPanel as mi_tab_panel, Tabs as mi_tabs };
